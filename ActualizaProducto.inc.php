...
<body>
    <h1 align="center">ACTUALIZAR PRODUCTOS COMPRADOS</h1>
    <div class="container">
        <table>
            <h3 align= "center">Los productos comprados tienen el siguiente detalle</h5>
            <thead>
                <tr>
                    <th>Id Producto</th>
                    <th>Nombre</th>
            ...
            <?php 
                ...
                while($datos = mysqli_fetch_array($consulta)){
                    ...
                    echo "<tr>";
                    echo "<td>".$datos_parcial['id_producto']."</td>";
                    echo "<td>".$nombre_producto."</td> ";
                    echo "<td>".$datos_parcial['cantidad']."</td>";
                    echo "<td>".$datos_parcial['precio_unitario']." Bs.</td>";
                    echo "</tr>";
                    
                    // echo "<td>".$cantidad_almacen."</td>";
                }
