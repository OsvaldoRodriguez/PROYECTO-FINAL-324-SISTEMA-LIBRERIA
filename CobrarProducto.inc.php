...
<head>
    ...
    <style>
        ...
        .cuadro{margin-left:5%; border-radius: .5em; width:  auto; font-size: 23px; border-collapse: collapse; text-align: center; overflow: hidden; box-shadow: 0 0 20px rgba(235, 8, 8, 0.1); background-color: rgba(253, 251, 251, 0.6);}
        .anuncio{border-radius: .5em;margin-top:5%;  width: auto; height: 120px; }
        .final{margin-bottom:5%;}    
    </style>
</head>
<body>
    <h1 align="center">SE REALIZA COBRO AL CLIENTE </h1>
    <div class="container">
        <div class="cuadro">
            <img src="img/cobrar.jpg" alt="" class="anuncio">
            <div class='final' >Se realiza el cobro por los productos pedidos.</div>
        </div>
    </div>
</body>
</html>