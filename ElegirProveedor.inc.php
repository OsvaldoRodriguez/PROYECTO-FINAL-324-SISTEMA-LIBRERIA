...
<head>
    ...
    <style>
        ...
        table { margin-left: 15%;width: 150%; overflow: hidden; box-shadow: 0 0 20px rgba(235, 8, 8, 0.1);}
...
<body>
    <h1 align="center">ELEGIR UN PROVEEDOR PARA SOLICITAR PRODUCTOS</h1>
    <div class="container">

        <table>
            <tr>
                <td><input type="radio" name="proveedor" value="11" class="uno"></td>
                <td><img  src="img/papelbol.png" alt="" class="imagen">  </td>
            </tr>
            <tr>
                <td><input type="radio" name="proveedor" value="12" class="uno"></td>
                <td><img src="img/lapapelera.jpg" alt=""  class="imagen"></td>
            </tr>
            <tr>
                <td><input type="radio" name="proveedor" value="10" class="uno"></td>
                <td> <img src="img/fabercastell.jpg" alt=""  class="imagen"> </td>
                
            </tr>
            <tr>
                <td><input type="radio" name="proveedor" value="13" class="uno"></td>
                <td><img src="img/cartonbol.jpg" alt=""  class="imagen"> </td>
            </tr>
