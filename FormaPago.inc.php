...
<head>
    ...
    <style>
        ...
        .imagen2{ width: 200px; height: 100px;}
        .imagen3{ width: 200px; height: 150x; margin-left: 38%; }
        .uno{width: 20px; height: 20px;}
        ...
        table { width: auto; overflow: hidden; box-shadow: 0 0 20px rgba(235, 8, 8, 0.1);}
...
<body>
    <h1 align="center">ELEGIR DE QUE FORMA SE REALIZARA EL PAGO</h1>
    <div class="container">

        <table>
            <tr>
                <th><img src="img/transferencia.jpeg" alt="" class="imagen2"><br><input type="radio" name="formapago" value="tranferencia" class="uno"></th>
                <th><img src="img/cheque.jpg" alt="" class="imagen2"><br><input type="radio" name="formapago" value="cheque" class="uno">  </th>
            </tr>
            <tr>
                <th> <img src="img/pagoqr.jpg" alt="" class="imagen2"><br><input type="radio" name="formapago" value="tranferencia" class="uno"></th>
                <th><img src="img/efectivo.jpg" alt="" class="imagen2"><br><input type="radio" name="formapago" value="cheque" class="uno">  </th>
            </tr>
        </table>
    </div>
</body>
