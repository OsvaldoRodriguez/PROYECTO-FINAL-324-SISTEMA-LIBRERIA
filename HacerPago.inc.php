...
<head>
    ...
    <style>
        ...
        .cuadro{ border-radius: .5em;width: auto; font-size: 22px; border-collapse: collapse; text-align: center; overflow: hidden; box-shadow: 0 0 0 10px rgba(235, 8, 8, 0.1); background-color: rgba(253, 251, 251, 0.6);}
        .anuncio2{ width: 450px; height: 200px; margin-top: 2%; text-align: center;}
    </style>
</head>
<body>
    <h1 align="center">PAGO DE PRODUCTOS</h1>
    
    <div class="container">
        <div class="cuadro">
            <br>
            <img src="img/cobrar.jpg" alt="" class="anuncio2">
            
            <div>
                <br>
                Cajas esta realizando el pago automaticamente hacia el proveedor.
                <br><br>
                Se notificara a Libreria sobre todos los gastos realizados.
            </div>
        </div>
    </div>
</body>
