...
<head>
    ...
    <style>
        ...
        .div1 { grid-area: 1 / 2 / 10 / 12; }
        .div2 { grid-area: 1 / 2 / 10 / 7; }
        .div3 { grid-area: 1 / 7 / 10 / 12; }
        .cuadro{border-radius: .5em; width: 100%; font-size: 20px; border-collapse: collapse; text-align: center; overflow: hidden; box-shadow: 0 0 20px rgba(235, 8, 8, 0.1); background-color: rgba(253, 251, 251, 0.6); }
...
<body>
    <h1 align="center">PRODUCTOS DISPONIBLES EN LA TIENDA </h1>
    <div class="parent">
        <div class="div1"></div>
        <div class="div2">
            <div class="cuadro1">
        ...
        <div class="div3">
            <div class="cuadro">
                <h3>Escoger producto:</h3>
                <select name="id_producto" class="buscar">
                    <?php
                        $sql = "select * from libreria.productos ";
                        $sql .= " where cantidad <= '1000000'";
               ...
               Cantidad:
               <input type="text" name="cantidad_producto" class="buscar1">
               <br><br>
                <img src="img/lib.jfif" alt="" class="lib">
                <h1></h1>
            </div>
        </div>
    </div>
