...
<head>
    ...
    <style>
        ...
        .cuadro{border-radius: .5em; width: auto; font-size: 25px; border-collapse: collapse; text-align: center; overflow: hidden; box-shadow: 0 0 20px rgba(235, 8, 8, 0.1); background-color: rgba(253, 251, 251, 0.6);}
        .anuncio{ width: auto; height: 150px; }
        .final{margin-bottom:5%;}
    </style>
</head>
<body>
    <h1 align="center">NOTIFICACIÓN DE COMPRA</h1>
    <div class="container">
        <div class="cuadro">
            <div> <img src="img/pagarcaja.png" alt="" class="anuncio"> </div>
            <div class="final"> Pasa a caja para realizar el pago de los productos comprados.</div>
         </div>
    </div>
</body>
</html>