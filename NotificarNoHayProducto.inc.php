...
<head>
    ...
    <title>Producto no existe</title>
    <style>
        html, body{
        ...
        .cuadro{ border-radius: .5em; width:  auto; font-size: 23px; border-collapse: collapse; text-align: center; overflow: hidden; box-shadow: 0 0 20px rgba(235, 8, 8, 0.1); background-color: rgba(253, 251, 251, 0.6);}
        .anuncio{margin-top:5%;  width: auto; height: 120px; }
        .final{margin-bottom:5%;}
    </style>
</head>
<body>
    <h1 align="center">NOTIFICACIÓN DE UN PRODUCTO PEDIDO</h1>
    <div class="container">
        <div class="cuadro">
            <div> <img src="img/mal.png" alt="" class="anuncio"> </div>
            <div class="final">
                <br>
                Lo sentimos el producto que pidio no se encuentra disponible. <br/>
                En los proximos dias ya estara disponible.
            </div>
        </div>
    </div>
</body>
