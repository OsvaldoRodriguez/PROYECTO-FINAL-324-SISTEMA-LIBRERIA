...
<head>
    ...
    <style>
        ...
        h1,h2,h3 {font-family:Century Gothic ; color: #FFFFFF;}
        ...
        table { width: 130%; overflow: hidden; box-shadow: 0 0 0 10px rgba(235, 8, 8, 0.1);}
...
<body>
    <h1 align="center">PRODUCTOS COMPRADOS</h1>
    
    <div class="container">
        <h3>La compra se  realizo con el siguiente detalle: </h3>
        <table>
            <thead>
                <tr>
                    <!-- <th>Id Producto</th> -->
            ...
            <?php 
                    ...
                    echo "<td colspan='4' align ='center' class= 'precio'> TOTAL PRECIO </td>";
