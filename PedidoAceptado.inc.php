...
<head>
    ...
    <style>
        ...
        .cuadro{border-radius: .5em; width: auto; font-size: 24px; border-collapse: collapse; text-align: center; overflow: hidden; box-shadow: 0 0 20px rgba(235, 8, 8, 0.1); background-color: rgba(253, 251, 251, 0.6);}
    </style>
</head>
<body>
    <h1 align="center">NOTIFICACIÓN DE COMPRA DE PRODUCTOS</h1>
    <div class="container">
        <div class="cuadro">
            El pedido realizado a nuestro proveedor llegó a la libreria de forma satisfactoria, por consiguiente pasaremos a actualizar nuestro stock de productos.
            <br><br>
            Pulse siguiente para ver el detalle de los productos comprados.
        </div>
    </div>
</body>
</html>