...
<head>
    ...
    <style>
        ...
        .container {border-radius: .4em; position: absolute; top: 40%; left: 50%; transform: translate(-50%, -50%); }
        .cuadro{border-radius: .3em; width: 105%; font-size: 25px; border-collapse: collapse; text-align: center; overflow: hidden; box-shadow: 0 0 20px rgba(235, 8, 8, 0.1); background-color: rgba(253, 251, 251, 0.6);}
        .imagen{border-radius: .5em; width: 300px; height: 40px; }
        .imagen2{border-radius: .5em; width: 200px; height: 100px; margin-left: 15%;}
        .imagen3{border-radius: .5em; width: auto; height: 150x; margin-left: 38%; }
        .uno{border-radius: .5em;width: 20px; height: 20px; margin-left: 50%; }
        .buscar{border-radius: .5em; width: 400px; height: 35px; font-size: 20px; margin-top:2%; margin-bottom:2%;}
        .buscar1{border-radius: .5em; width: 90px; height: 30px; font-size: 20px; margin-top:2%;}
        .anuncio{border-radius: .5em; width: 350px; height: 150px; }
        .anuncio2{border-radius: .5em; width: 450px; height: 200px; margin-top: 2%; text-align: center;}
        table { width: 150%; border-collapse: collapse; overflow: hidden; box-shadow: 0 0 20px rgba(235, 8, 8, 0.1);}
...
<body>
    <h1 align="center">SELECCIONA EL PRODUCTO A PEDIR:</h1>
    <img src="img/buscarp.png" alt="" class="imagen3">
    <div class="container">
        <br><br><br>
        <div class="cuadro">
           ...
           Cantidad:
           <input type="text" name="cantidad" class="buscar1">
           <!-- <br> -->
        </div>
    </div>
</body>
