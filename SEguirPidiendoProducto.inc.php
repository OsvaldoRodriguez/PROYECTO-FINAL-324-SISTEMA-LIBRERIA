...
<head>
    ...
    <title>Volver a realizar compras</title>
    <style>
        ...
        select, table { font-family:Century   ;}
        ...
        .container { position: absolute; top: 40%; left: 48%; transform: translate(-50%, -50%); }
        .cuadro{border-radius: .5em; width: 120%; font-size: 25px; border-collapse: collapse; text-align: center; overflow: hidden; box-shadow: 0 0 20px rgba(235, 8, 8, 0.1); background-color: rgba(253, 251, 251, 0.6);}
...
<body>
    ...
    <div class="container">
        <div class="cuadro">
            <br>
            <div> <img src="img/continuar.png" alt="" class="anuncio"> </div>
            <br>
            <div>
                Si desea comprar mas productos <br/>
                Puede realizarlo!!!
            </div>
            <br>
