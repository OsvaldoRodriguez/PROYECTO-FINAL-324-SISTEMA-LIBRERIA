...
<head>
    ...
    <title>Lista de productos pedidos</title>
    <style>
        html, body{
        ...
        .container {position: absolute; top: 40%; left: 45%; transform: translate(-50%, -50%); }
        ...
        table { width: 120%; collapse; overflow: hidden; box-shadow: 0 0 20px rgba(235, 8, 8, 0.1);}
...
<body>
    <h1 align="center">LISTA DE PRODUCTOS SOLICITADOS POR EL CLIENTE</h1>
    <div class="container">
        <table>
            <thead>
                <tr>
            ...
            <tbody>
                ...
                <?php
                    ...
                    while($datos = mysqli_fetch_array($consulta)) {
                        ...
                        $sql.= "where id_producto='".$datos['id_producto']."'";
                        ...
                        $cantidad_libreria = $datos_parcial['cantidad'];
                        ...
                        // echo "<td>".$datos['cantidad']."</td>";
                        echo "<td>".$cantidad_libreria."</td>";

                        if($cantidad_libreria >= $datos['cantidad']){
                            echo "<td class='color_verde'> Se puede vender </td>";
                        }else{
                            echo "<td class='color_rojo'> No se puede vender </td>";
                        }
                        echo "</tr>";
                    }
                ?>
