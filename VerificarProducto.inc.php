...
<head>
    ...
    <style>
        ...
        table {width: auto; overflow: hidden; box-shadow: 0 0 0 10px rgba(235, 8, 8, 0.1);}
...
<body>
    <h1 align="center">LISTA DE PRODUCTOS A VERIFICAR</h1>
    <br>
    <div class="container">
        <table>
            <thead>
            ...
            <tbody>
                ...
                <?php
                    ...
                    while($datos = mysqli_fetch_array($consulta)) {
                        // print_r($datos);
                        echo "<tr>";
                        // hacer otra consulta con el id_producto para saber el nombre
                        ...
                        $cantidad_almacen = 0;
                        if(isset($datos_parcial_proveedor['cantidad'])) { // si  no existe el producto
                        ...
                        if($cantidad_almacen >= $datos['cantidad']){
                            echo "<td class='color_verde'> Disponible </td>";
                            
                        }else{
                            
                            echo "<td class='color_rojo'> No Disponible </td>";
