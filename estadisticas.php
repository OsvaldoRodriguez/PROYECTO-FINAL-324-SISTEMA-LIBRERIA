...
<head>
    ...
    <style>
        ...
        .buscar{border-radius: .5em; width: 350px; height: 35px; font-size: 18px; }
        ...
        table {border-radius: .5em; margin-top:2%; margin-bottom: 2%; margin-left: 2%; width: 96%; overflow: hidden; box-shadow: 0 0 20px rgba(235, 8, 8, 0.1); text-align: center; }
        th, td {border-radius: .3em; padding: 1.5px; background-color: rgba(253, 251, 251, 0.5); color: #141212;}
        thead { background-color: rgba(253, 251, 251, 0.9);}
        .lib{border-radius: .5em; width: 90%; height: 180px; }

        .container { border-radius: .5em;position: absolute; top: 40%; left: 50%; transform: translate(-50%, -50%); }
        ...
        .anuncio{border-radius: .5em;margin-top:5%;  width: auto; height: 120px; }
        .final{border-radius: .5em;margin-bottom:5%;}
        
        
        /* .div1 { grid-area: 2 / 2 / 9 / 12; }
        .div2 { grid-area: 9 / 3 / 10 / 5; } */
        .div1 { grid-area: 9 / 5 / 9 / 8; }
        .div2 { grid-area: 9 / 7 / 9 / 10; }
...
<body>
    <h1 align="center">ESTADISTICAS LIBRERIA </h1>
    ...
    <div class="container">
        <div class="cuadro">
            ...
            <div class="final">
                ...
                En este modulo podremos ver estadisticas de la Libreria <br/>
                Tanto de ventas como compras
            </div>
        </div>
    </div>
    ...
    <div class='parent'>
        ...
        <div class='div1'>
            <form  method="GET" action="estadisticas_compras.php">
                <button class="boton" type='submit' name='estadisticas_compras' value = 'estadisticas_compras'> Compras </button>
            </form>
        </div>
        ...
        <div class='div2'>
            <form  method="GET" action="estadisticas_ventas.php">
                <button class="boton" type='submit' name='estadisticas_ventas' value = 'estadisticas_ventas'> Ventas </button>
            </form>
        </div>
        ...
        <div class='div5'>
            <form  method="GET" action="bentrada.php">
