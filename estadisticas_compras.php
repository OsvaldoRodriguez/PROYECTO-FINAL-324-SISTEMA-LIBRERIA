...
<body>
    <h1 align="center">ESTADISTICAS COMPRAS A PROVEEDOR </h1>
    ...
    <div class="container">
        <div class="cuadro">
            ...
            <div class="final">
                <br>
                Lista de todas las compras hasta el momento
            </div>
        </div>
        <table>
            <thead>
            ...
            <tbody>
                <?php 
                    ...
                    $sql = "select * from libreria.compras ";
                    $consulta = mysqli_query($con, $sql);
                    while($datos = mysqli_fetch_array($consulta)){

                        $nombre_proveedor;
                        $sql_prov = "select * from libreria.proveedor where id_proveedor=".$datos['id_proveedor']." ";
                        $consulta_prov = mysqli_query($con, $sql_prov);
                        $d_prov = mysqli_fetch_array($consulta_prov);
                        $nombre_proveedor = $d_prov['nombre_prov'];
                        echo "<tr>"; 
                        echo "<td>".$datos['id_pedido']."</td>";
                        echo "<td>".$datos['fecha']."</td>";
                        echo "<td>".$nombre_proveedor."</td>";
                        echo "<td>".$datos['precio_compra']." Bs.</td>";
                        echo "</tr>";
                        $precio_total += $datos['precio_compra'];
