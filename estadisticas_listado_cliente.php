...
$sql_v = "select * from libreria.clientes where id_cliente='".$_GET['id_producto_comprado']."'";
$con_v = mysqli_query($con, $sql_v);
$datos_v = mysqli_fetch_array($con_v);
?>
...
<head>
    ...
    <style>
        ...
        h1 ,h2, h3,h4{font-family:Century Gothic ; color: #FFFFFF;}
        ...
        .cuadro{margin-left: 5%;border-radius: .5em; border-radius: .5em; width:  125%; font-size: 23px; border-collapse: collapse; text-align: center; overflow: hidden; box-shadow: 0 0 20px rgba(235, 8, 8, 0.1); background-color: rgba(253, 251, 251, 0.6);}
        ...
        .div4 { grid-area: 9 / 6 / 11 / 9; }
        .div5 { grid-area: 11 / 6 / 11 / 9; }
...
<body>
    ...
    <div class="container">
        <div class="cuadro">
            ...
            <div class="final">
                <br>
                <strong>Nombre:</strong> <?php echo $datos_v['nombre'] ?> <br/>
                <strong>Ci:</strong> <?php echo $datos_v['ci'] ?> <br/>
                <strong>Correo:</strong> <?php echo $datos_v['email'] ?> <br/>
                
            </div>

        </div>
        <h2> Lista de Productos vendidos a <?php echo $datos_v['nombre'] ?> </h2>
        <table>
            <thead>
                <tr>
                    <th>Codigo Venta</th>
            ...
            <tbody>
                <?php 
                    ...
                    $sql = "select * from libreria.ventas where id_cliente='".$_GET['id_producto_comprado']."' ";
                    $consulta = mysqli_query($con, $sql);
                    while($datos = mysqli_fetch_array($consulta)){

                        echo "<tr>"; 
                        echo "<td>".$datos['id_cliente']."</td>";
                        echo "<td>".$datos['id_pedido']."</td>";
                        echo "<td>".$datos['fecha']."</td>";
                        echo "<td>".$datos['precio_venta']." Bs.</td>";
                        echo "</tr>";
                        $precio_total += $datos['precio_venta'];
                        
                    }
                   
                    echo "<td colspan='3' align ='center' class='precio' > TOTAL PRECIO </td>";
    ...
    <div class='parent'>
        <div class='div5'>
            <form  method="GET" action="estadisticas_ventas.php">
