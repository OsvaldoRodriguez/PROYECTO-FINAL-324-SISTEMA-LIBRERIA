...
<head>
    ...
    <style>
        ...
        /* .cuadro{ width: 100%; font-size: 20px; border-collapse: collapse; text-align: left; overflow: hidden; box-shadow: 0 0 20px rgba(235, 8, 8, 0.1); background-color: rgba(253, 251, 251, 0.6); }
        .buscar{ width: 350px; height: 35px; font-size: 18px; }
        .buscar1{ width: 100px; height: 35px; font-size: 18px; }
        .cuadro1{ width: 90%; font-size: 18px; border-collapse: collapse; text-align: center; overflow: hidden; box-shadow: 0 0 20px rgba(235, 8, 8, 0.1); background-color: rgba(253, 251, 251, 0.6); }
        table { width: 100%; overflow: hidden; box-shadow: 0 0 20px rgba(235, 8, 8, 0.1); text-align: left; }
        th, td { padding: 1.5px; background-color: rgba(253, 251, 251, 0.5); color: #141212;}
        thead { background-color: rgba(253, 251, 251, 0.9);}
        .lib{ width: 100%; height: 180px; } */
    </style>
...
<body>
    <div class="login-page">
        ...
        <div class="form">
            <form class="login-form" method="GET" action="indexcontrol.php">
                <input type="text" placeholder="Usuario" name="usuario" id="usuario"/>
                <input type="password" placeholder="Contraseña" name="contrasenia" placeholder="Password"/>
